...
const registerBorrower = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while registering the borrower" });
  }
};
...
const updateBorrower = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while updating the borrower" });
  }
};
...
const deleteBorrower = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while deleting the borrower" });
  }
};
...
const listBorrowers = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "An error occurred while fetching borrowers" });
  }
};
